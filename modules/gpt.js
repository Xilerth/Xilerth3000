    ...
    messages: [
      {
        role: "user",
        content: trim(
          `Combina un adjetivo con un sustantivo y otro sustantivo para crear un nombre de usuario compuesto único. El resultado tiene que tener formato json {"username": "nombre"}`
        ),
      },
    ],
    model: MODEL,
